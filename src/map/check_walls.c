...
/*   Updated: 2025/09/25 11:51:26 by ulfernan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "cub3d.h"

int	flood_fill(t_cub3d_data *data, char **map, int row, int col)
{
	if (row < 0 || col < 0
...
void	copy_map_into_fill(char **map, char **fill_map)
{
	int	i;
	int	j;
...
char	**fill_boundaries(t_cub3d_data *data, char **map)
{
	char	**fill_map;
	int		i;
	int		j;
