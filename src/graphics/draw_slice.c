...
/*   Updated: 2025/10/14 18:50:09 by ulfernan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	get_texture_byte(t_cub3d_data *data, int *color)
{
	...
	index = data->dda->tex_y * data->dda->wall_texture->line_length
		+ data->dda->tex_x * (data->dda->wall_texture->bits_per_pixel / 8);
...
void	draw_slice(t_cub3d_data *data, int x)
{
	...
	{
		data->dda->tex_y = ((int)precise_tex_y * 2)
			% data->dda->wall_texture->height;
		if (data->dda->tex_y < 0)
			data->dda->tex_y = 0;
